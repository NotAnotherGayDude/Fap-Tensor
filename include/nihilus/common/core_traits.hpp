...
namespace nihilus {
	...
	template<model_config config_new> struct core_traits<config_new, op_types::output_weight>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::output_weight>, model_traits_type<config_new>::embedding_dim, model_traits_type<config_new>::vocab_size, 1, 1> {
		NIHILUS_FORCE_INLINE core_traits() noexcept								 = default;
		NIHILUS_FORCE_INLINE core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE core_traits(const core_traits&) noexcept			 = delete;
		NIHILUS_FORCE_INLINE core_traits& operator=(core_traits&&) noexcept		 = delete;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kq_mask>
		...
		using core_traits_dims_type =
			core_trait_dims<core_traits<config_new, op_types::kq_mask>, model_traits_type::max_sequence_length, model_traits_type::max_sequence_length, 1, 1, 0>;
		static constexpr uint64_t depth{ 0 };
		static constexpr auto config{ config_holder<config_new>::config };
		static constexpr alloc_type alc_type{ alloc_type::single_alloc };
		static constexpr array<uint64_t, 4> strides{ type_traits<output_type>::impl(core_traits_dims_type::get_array()) };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::inp_embd>
		...
		using core_traits_dims_type =
			core_trait_dims<core_traits<config_new, op_types::inp_embd>, model_traits_type::embedding_dim, model_traits_type::max_sequence_length, 1, 1, 1>;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::norm_attn_norm>
		...
		using core_traits_dims_type =
			core_trait_dims<core_traits<config_new, op_types::norm_attn_norm>, model_traits_type::embedding_dim, model_traits_type::max_sequence_length, 1, 1, 1>;
		static constexpr uint64_t depth{ std::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
		static constexpr auto config{ config_holder<config_new>::config };
		static constexpr alloc_type alc_type{ alloc_type::single_alloc };
	...
	template<model_config config_new> struct core_traits<config_new, op_types::qcur>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::qcur>, model_traits_type<config_new>::head_count * model_traits_type<config_new>::head_dim,
	...
	template<model_config config_new> struct core_traits<config_new, op_types::qcur_reshaped>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::qcur_reshaped>, model_traits_type<config_new>::head_dim, model_traits_type<config_new>::max_sequence_length,
		...
		using output_type														 = typename kernel_type_profile_traits<config_new.kernel_profile>::query_type;
		using core_traits_dims_type = core_trait_dims<core_traits<config_new, op_types::qcur_reshaped>, model_traits_type::head_dim, model_traits_type::max_sequence_length,
	...
	template<model_config config_new> struct core_traits<config_new, op_types::qcur_rope>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::qcur_rope>, model_traits_type<config_new>::head_dim, model_traits_type<config_new>::max_sequence_length,
			  model_traits_type<config_new>::head_count, 1, 1> {
		NIHILUS_FORCE_INLINE core_traits() noexcept								 = default;
		NIHILUS_FORCE_INLINE core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE core_traits(const core_traits&) noexcept			 = delete;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kcur>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::kcur>, model_traits_type<config_new>::head_count_kv * model_traits_type<config_new>::head_dim,
			  model_traits_type<config_new>::max_sequence_length, 1, 1, 1> {
		NIHILUS_FORCE_INLINE core_traits() noexcept								 = default;
		NIHILUS_FORCE_INLINE core_traits& operator=(const core_traits&) noexcept = delete;
		NIHILUS_FORCE_INLINE core_traits(const core_traits&) noexcept			 = delete;
	...
	template<model_config config_new> struct core_traits<config_new, op_types::kcur_reshaped>
		: public config_holder<config_new>,
		  core_trait_dims<core_traits<config_new, op_types::kcur_reshaped>, model_traits_type<config_new>::head_dim, model_traits_type<config_new>::max_sequence_length,
		...
		using output_type														 = typename kernel_type_profile_traits<config_new.kernel_profile>::key_type;
		using core_traits_dims_type = core_trait_dims<core_traits<config_new, op_types::kcur_reshaped>, model_traits_type::head_dim, model_traits_type::max_sequence_length,
	...
	template<model_config config_new> struct core_traits<config_new, op_types::result_output>
		...
		using core_traits_dims_type =
			core_trait_dims<core_traits<config_new, op_types::result_output>, model_traits_type::vocab_size, model_traits_type::max_sequence_length, 1, 1, 1>;
		static constexpr uint64_t depth{ std::max(input_type01::depth, input_type02::depth) + 1 };
		static constexpr auto config{ config_holder<config_new>::config };
		static constexpr alloc_type alc_type{ alloc_type::single_alloc };
		static constexpr bool dequantization{ requires_dequant_or_quant<typename input_type01::output_type, typename input_type02::output_type>::required };
